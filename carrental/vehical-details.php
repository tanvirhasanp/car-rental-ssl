...
echo "<script type='text/javascript'> document.location = 'payment_fixed.php'; </script>";
}
else 
{
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal">Login For Book</a>
